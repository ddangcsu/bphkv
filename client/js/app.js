...
const app = createApp({
  setup() {
    ...
    const EVENT_TYPES = [
      { value: "ADM", label: "Admin/Security" },
    ...
    function formatOptionLabel(opt) {
      ...
      if (typeof opt.value === "boolean") return opt.label;
    ...
    const familyFields = {
      household: {
        main: [
          { col: "id", label: "Family ID", type: "text", placeholder: "FAM_001", default: "", show: () => familyMode.value === "create" },
          { col: "parishMember", label: "Parish Member", type: "select", selOpt: YES_NO_OPTIONS, default: true },
          { col: "parishNumber", label: "Parish Number", type: "text", default: "", show: () => familyForm.parishMember === true },
        ],
        address: [
      ...
      contacts: [
        ...
        { col: "phone", label: "Contact Phone", type: "tel", onInput: formatUSPhone, placeholder: "(714) 123-4567", default: "" },
        { col: "email", label: "Email Address", type: "text", default: "" },
        { col: "isEmergency", label: "Emergency Contact", type: "checkbox", default: false },
      ],
      children: [
        { col: "childId", label: "Child ID", type: "text", show: false, default: () => uid() },
        { col: "lastName", label: "Last Name", type: "text", default: "" },
        { col: "firstName", label: "First Name", type: "text", default: "" },
        { col: "middle", label: "Middle", type: "text", default: "" },
      ...
      main: [
        {
          ...
          label: "Event ID",
          type: "text",
          placeholder: "REG_TNTT_2025",
          default: "",
          disabled: () => eventMode.value === "edit",
        },
        { col: "programId", label: "Program", type: "select", selOpt: PROGRAM_OPTIONS, default: () => PROGRAM_OPTIONS[0].value },
        ...
        { col: "year", label: "Year", type: "select", selOptFn: () => YEAR_OPTIONS.value, default: () => new Date().getFullYear() },
      ...
      prerequisiteRow: [
        {
          ...
          type: "select",
          selOptFn: ({ index }) => availablePrerequisiteOptions(index).map((e) => ({ value: e.id, label: e.id })),
          default: "",
          relativeDisplay: [
